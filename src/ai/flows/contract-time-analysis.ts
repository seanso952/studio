...
const analyzeContractTimePrompt = ai.definePrompt({
  ...
  If the contract is expiring within 3 months, nearExpiryAlert should be set to true and provide a relevant alert message. Otherwise, nearExpiryAlert should be false and alertMessage should be empty.
`,
});
